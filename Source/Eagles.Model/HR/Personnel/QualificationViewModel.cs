...
namespace Eagle.Model.HR
{
    ...
    public class TrainingPlaceModel
    {
        public int TrainingPlaceId { get; set; }
        public string TrainingPlaceName { get; set; }
    }

    public class TrainingPlaceModelList
    {
        public List<TrainingPlaceModel> TrainingPlaceList { get; set; }
        public TrainingPlaceModelList(int LanguageId)
        {
            if (LanguageId == 124)
            {
                TrainingPlaceList = new List<TrainingPlaceModel>()
                {
                    new TrainingPlaceModel(){ TrainingPlaceId = 1, TrainingPlaceName = "Domestic" },
                    new TrainingPlaceModel(){ TrainingPlaceId = 2, TrainingPlaceName = "Overseas" }
                };
            }
            else
            {
                TrainingPlaceList = new List<TrainingPlaceModel>()
                {
                    new TrainingPlaceModel(){ TrainingPlaceId = 1, TrainingPlaceName = "Trong nước" },
                    new TrainingPlaceModel(){ TrainingPlaceId = 2, TrainingPlaceName = "Ngoài nước" }
                };
            }
        }
    }
    ...
    public class QualificationViewModel
    {
        ...
        [Remote("ValidateCode", "Qualification", AdditionalFields = "QualificationNo")] 
        ...
        [Display(ResourceType = typeof(Eagle.Resource.LanguageResource), Name = "LSQualificationName")]
      ...
      //  [Required(ErrorMessageResourceType = typeof(Eagle.Resource.LanguageResource), ErrorMessageResourceName = "Required")]
       ...
       // [Required(ErrorMessageResourceType = typeof(Eagle.Resource.LanguageResource), ErrorMessageResourceName = "Required")]
        ...
        public Nullable<int> LSSchoolID { get; set; }
         ...
         [Display(ResourceType = typeof(Eagle.Resource.LanguageResource), Name = "LSSchoolName")]
        ...
        public Nullable<int> LSFacultyID { get; set; }
         ...
         [Display(ResourceType = typeof(Eagle.Resource.LanguageResource), Name = "LSFacultyName")]
        ...
        public Nullable<int> LSTrainingTypeID { get; set; }
         ...
         [Display(ResourceType = typeof(Eagle.Resource.LanguageResource), Name = "LSTrainingTypeName")]
        ...
        [Display(ResourceType = typeof(Eagle.Resource.LanguageResource), Name = "LSCountryName")]
