    ...
    {        
        ...
        public ActionResult Index(int? EvaluationTemplateID)
        {
            if (EvaluationTemplateID.HasValue)
            {
                ...
                return View("../TR/EvaluationTemplate/Edit", EvaluationTemplateID);
            }
            else
            {
                if (this.Request.IsAjaxRequest())
                {
                    return this.PartialView("../TR/EvaluationTemplate/_Reset");
                }
                else
                {
                    if (this.CurrentAcc == null)
                    ...
                    return this.View("../TR/EvaluationTemplate/Index");
                }
            }                                                
        }
        ...
        public ActionResult _Create(int? EvaluationTemplateID)
        {
            if (EvaluationTemplateID.HasValue)
            {
                ...
                if (template != null)
                {
                    ...
                    return this.PartialView("../TR/EvaluationTemplate/_Create", template);
                }
            }
            var model = new EvaluationTemplateViewModel();
            this.CreateViewBag(model);
            return PartialView("../TR/EvaluationTemplate/_Create", model);            
        }
        ...
        public ActionResult ListOfApprisalPart(int? EvaluationTemplateID)
        {
            ...
            {                
                ...
                return this.PartialView("../TR/EvaluationTemplate/_ListOfApprisalPart", found.ListOfTemplateDetail);
            }
            ...
            return this.PartialView("../TR/EvaluationTemplate/_ListOfApprisalPart", ListOfTemplateDetail);
        }        
        ...
        {            
            ...
            this.CreateViewBag(found);
            return PartialView("../TR/EvaluationTemplate/_Create", found);
        }       
