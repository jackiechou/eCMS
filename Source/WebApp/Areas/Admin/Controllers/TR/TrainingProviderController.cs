...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingProviderController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../TR/TrainingProvider/_Reset");
            }
            else
            {
                return this.View("../TR/TrainingProvider/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../TR/TrainingProvider/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../TR/TrainingProvider/_Create", model);
        }
