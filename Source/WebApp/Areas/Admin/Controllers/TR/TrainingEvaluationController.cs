    ...
    {        
        ...
        public ActionResult Index(int? TrainingEvaluationID)
        {
            if (TrainingEvaluationID.HasValue)
            {
                ...
                return View("../TR/TrainingEvaluation/Edit", TrainingEvaluationID);
            }
            else
            {
                if (this.Request.IsAjaxRequest())
                {
                    return this.PartialView("../TR/TrainingEvaluation/_Reset");
                }
                else
                {
                    if (this.CurrentAcc == null)
                    ...
                    return this.View("../TR/TrainingEvaluation/Index");
                }
            }                                                
        }
        ...
        {            
            ...
            return PartialView("../TR/TrainingEvaluation/_Create", model);            
        }
        ...
        public ActionResult ListOfTrainingEvaluationPart(int? TrainingEvaluationID, int? TrainingRequestID)
        {
            ...
            if (TrainingEvaluationID > 0)
            {
                ...
                return this.PartialView("../TR/TrainingEvaluation/_ListOfApprisalPart", found.ListOfTrainingEvaluationPart);
            }
            if (TrainingRequestID.HasValue)
            {
            ...
            var model = new TrainingEvaluationViewModel();
            return this.PartialView("../TR/TrainingEvaluation/_ListOfApprisalPart", model.ListOfTrainingEvaluationPart);
        }
        ...
        {            
            ...
            if (TrainingEvaluationID.HasValue)
            {
                ...
                return PartialView("../TR/TrainingEvaluation/_Create", found);
            }
            var model = new TrainingEvaluationViewModel();
            this.CreateViewBag(model);
            return PartialView("../TR/TrainingEvaluation/_Create", model);
