...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingApprisalPartController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../TR/TrainingApprisalPart/_Reset");
            }
            else
            {
                return View("../TR/TrainingApprisalPart/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../TR/TrainingApprisalPart/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            model.Used = true;
            return PartialView("../TR/TrainingApprisalPart/_Create", model);
        }
