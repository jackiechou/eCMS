...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingExpensesController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../TR/TrainingExpenses/_Reset");
            }
            else
            {
                return this.View("../TR/TrainingExpenses/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../TR/TrainingExpenses/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../TR/TrainingExpenses/_Create", model);
        }
