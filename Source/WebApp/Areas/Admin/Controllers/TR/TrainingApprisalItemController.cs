    ...
    public class TrainingApprisalItemController : BaseController
    {
        ...
        public ActionResult Index(int? id)
        {
            if (id.HasValue)
            {
                ...
                return View("../TR/TrainingPlan/Edit", id);
            }
            else
            {
                if (Request.IsAjaxRequest())
                {
                    return this.PartialView("../TR/TrainingApprisalItem/_Reset");
                }
                else
                {
                    if (CurrentAcc == null)
                    ...
                    return View("../TR/TrainingApprisalItem/Index");
                }
            }            
        }
        ...
        public ActionResult AddRowOfTrainingAnswer(List<TrainingAnswerTypeViewModel> listOfTrainingAnswer)
        {
            ...
            return this.PartialView("../TR/TrainingApprisalItem/_ListOfTrainingAnswer", listOfTrainingAnswer);
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../TR/TrainingApprisalItem/_List", result);
        }
        ...
        public ActionResult ListOfTrainingAnswer(int? id)
        {
            ...
            return this.PartialView("../TR/TrainingApprisalItem/_ListOfTrainingAnswer", listOfTrainingAnswerForAdding);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../TR/TrainingApprisalItem/_Create", model);
        }
