...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    {        
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../TR/TrainingPlanReport/Reset");
            }
            else
            {
                return this.View("../TR/TrainingPlanReport/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../TR/TrainingPlanReport/Create", model);
        }
        ...
        {
            return this.PartialView("../TR/TrainingPlanReport/TrainingPlanReportViewer");
        }
        ...
        public ActionResult LoadTrainingPlanReportViewer(int? Month, int? Year)        
        {
            ...
            return PartialView("../TR/TrainingPlanReport/TrainingPlanReportViewer");
        }
