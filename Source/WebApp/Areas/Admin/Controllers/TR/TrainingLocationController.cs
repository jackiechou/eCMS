...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingLocationController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../TR/TrainingLocation/_Reset");
            }
            else
            {
                return View("../TR/TrainingLocation/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../TR/TrainingLocation/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../TR/TrainingLocation/_Create", model);
        }
