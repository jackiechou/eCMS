...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class ReconciliationController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Timesheet/Reconciliation/Index");
        }
        public ActionResult _HeaderSearchEmp()
        {
            ViewBag.Year = System.DateTime.Now.Year;
            return PartialView("../Timesheet/Reconciliation/_HeaderSearchEmp");
        }
        /// <summary>
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Timesheet/Reconciliation/_List",Sources);
        }
        [HttpPost]
        ...
        public ActionResult _CreateError(List<ReconciliationViewModel> model, string ErrorMessage)
        {
            ...
            return PartialView("../Timesheet/Reconciliation/_Create", model);
