...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class ScheduleChangeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Timesheet/ScheduleChange/_Index");
            }
            else
            {
                return View("../Timesheet/ScheduleChange/Index");
            }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Timesheet/ScheduleChange/_List", sources);
        }
        [HttpPost]
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Timesheet/ScheduleChange/_Create", model);
        }
