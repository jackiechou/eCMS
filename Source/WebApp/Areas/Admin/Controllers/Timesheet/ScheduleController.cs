    ...
    public class ScheduleController : BaseController
    {
        ...
        #region Master
            public ActionResult Index()
            {
                ...
                {
                    return PartialView("../Timesheet/Schedule/_Index");
                }
                else
                {
                    return View("../Timesheet/Schedule/Index");
                }
            }
            public ActionResult _Create()
            {
                ...
                return PartialView("../Timesheet/Schedule/_Create", model);
            }
            public ActionResult _List()
            {
                ...
                return PartialView("../Timesheet/Schedule/_List", sources);
            }
        ...
        #region Detail
            ...
            public ActionResult _CreateErrorDetail(ScheduleDetailCreateViewModel model, string ErrorMessage)
            {
                ...
                return PartialView("../Timesheet/Schedule/ReloadInput", model);
            ...
            public ActionResult _PopupDetail()
            {
                ...
                return PartialView("../Timesheet/Schedule/_popupScheduleDetail", model);
            }
            ...
            public ActionResult _FillData(ScheduleFindViewModel model, int optInclude, List<ScheduleDetailListViewModel> List)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    return PartialView("../Timesheet/Schedule/_TablePartial", List);
                }
                else {
                    return Content("error");
                }
            ...
            public ActionResult _Reset(ScheduleDetailViewModel model)
            {
                ...
                return PartialView("../Timesheet/Schedule/_TablePartial", listNew);
            }
            // page load
