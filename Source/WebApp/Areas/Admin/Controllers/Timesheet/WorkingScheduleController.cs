...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class WorkingScheduleController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Timesheet/WorkingSchedule/Reset");
            }
            else
            {
                return this.View("../Timesheet/WorkingSchedule/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Timesheet/WorkingSchedule/Create", model);
        }
        ...
        public ActionResult Report(Timesheet_sprptShiftOfWorkingSchedule_Result model, int? Month, int? Year)
        {
            ...
            return this.PartialView("../Timesheet/WorkingSchedule/WorkingSchedule31ReportViewer");
        }
        ...
        public ActionResult LoadWorkingScheduleReportViewer()
        {
            ...
            if (numberOfDays == 30)
            {
                ...
                return this.PartialView("../Timesheet/WorkingSchedule/WorkingSchedule30ReportViewer");
            }
            if (numberOfDays == 29)
            {
                this.ViewData["Report"] = this.CreateWorkingSchedule29Report(model);
                return this.PartialView("../Timesheet/WorkingSchedule/WorkingSchedule29ReportViewer");
            }
            if (numberOfDays == 28)
            {
                this.ViewData["Report"] = this.CreateWorkingSchedule28Report(model);
                return this.PartialView("../Timesheet/WorkingSchedule/WorkingSchedule28ReportViewer");
            }
