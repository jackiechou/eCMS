...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class OTLimitByStaffController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Timesheet/OTLimitByStaff/Index");
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Timesheet/OTLimitByStaff/_List", sources);
        }
        ...
        {
            return PartialView("../Timesheet/OTLimitByStaff/_HeaderSearchEmp");
        }
        public ActionResult _CreateError(List<OTLimitByStaffListViewModel> model, string ErrorMessage)
        {
            ...
            return View("../Timesheet/OTLimitByStaff/Index", model);
        }
