...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class HolidaysController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Timesheet/Holidays/_Index");
            }
            else
            {
        ...
        public ActionResult _Search(int id)
        {
            ...
            ViewBag.iYear = id;
            return PartialView("../Timesheet/Holidays/_Create", list);
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Timesheet/Holidays/_List", null);
        }
        public ActionResult _CreateError(List<HolidayViewModel> model, string ErrorMessage)
        {
            ...
            return PartialView("../Timesheet/Holidays/_Create", model);
