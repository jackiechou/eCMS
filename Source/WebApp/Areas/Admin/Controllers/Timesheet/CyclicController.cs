    ...
    public class CyclicController : BaseController
    {
        ...
        #region Master
            public ActionResult Index()
            {
                ...
                {
                    return PartialView("../Timesheet/Cyclic/_Reset");
                }
                else
                {
                    return View("../Timesheet/Cyclic/Index");
                }
            }
            public ActionResult _Create()
            {
                ...
                return PartialView("../Timesheet/Cyclic/_Create", model);
            }
            public ActionResult _List()
            {
                ...
                return PartialView("../Timesheet/Cyclic/_List", sources);
            }
        ...
        public ActionResult _PopupDetail(int CyclicID)
            {
                ...
                return PartialView("../Timesheet/Cyclic/_popupDetail", null);
            }
