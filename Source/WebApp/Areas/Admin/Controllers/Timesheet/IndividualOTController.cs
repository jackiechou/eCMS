...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class IndividualOTController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Timesheet/IndividualOT/Index");
        }
        public ActionResult _SearchHeaderEmp()
        {
            return PartialView("../Timesheet/IndividualOT/_HeaderEmpSearch");
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Timesheet/IndividualOT/_List", sources);
        }
