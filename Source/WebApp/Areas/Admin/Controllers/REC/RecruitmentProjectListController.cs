...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentProjectListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../REC/RecruitmentProjectList/Index");
        }
        public ActionResult _Create()
        {
            ...
            return PartialView("../REC/RecruitmentProjectList/_Create", model);
        }
        public ActionResult _List(RecruitmentProjectSearchViewModel model)
        {
            ...
            return PartialView("../REC/RecruitmentProjectList/_List", lst);
        }
        [HttpPost]
