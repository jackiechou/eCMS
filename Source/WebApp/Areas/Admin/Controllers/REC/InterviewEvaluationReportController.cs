...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class InterviewEvaluationReportController : BaseController
    {
        ...
        {
            CreateViewBag();
            return PartialView("../REC/InterviewEvaluationReport/_Create");
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("../REC/InterviewEvaluationReport/Index");
        }
        //public ActionResult Report()
        //{
        //    return this.PartialView("../REC/InterviewEvaluationReport/_Report");
        //}
        ...
        public ActionResult ReportViewerPartial(int? ProjectID, int? ProjectTournamentID, string strProject, string strProjectTournament, bool Mode, bool isCallBack)
        {
            ...
            return PartialView("../REC/InterviewEvaluationReport/ReportViewerPartial");
        }
