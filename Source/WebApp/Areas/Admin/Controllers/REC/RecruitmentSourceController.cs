...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentSourceController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../REC/RecruitmentSource/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../REC/RecruitmentSource/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../REC/RecruitmentSource/_List", list);
        }
        public ActionResult _Create()
        {
            LS_tblRecruitmentSource model = new LS_tblRecruitmentSource();
            model.Used = true;
            return PartialView("../REC/RecruitmentSource/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../REC/RecruitmentSource/_Create", modelEntity);
        }
        [HttpPost]
