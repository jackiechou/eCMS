...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class PlanListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../REC/PlanList/Index");
        }
        public ActionResult _Create()
        {
            ...
            CreateStatusViewBag();
            #endregion
            return PartialView("../REC/PlanList/_Create", model);
        }
        ...
        public ActionResult _List(int YearAlowNull, int? LSCompanyID, int? LSPositionIDAlowNull,int? StatusPlan)
        {
            if (CurrentAcc != null)
            {
                ...
                return PartialView("../REC/PlanList/_List", List);
            }
            else
            {
                return PartialView("../REC/PlanList/_List");
            }
        }
