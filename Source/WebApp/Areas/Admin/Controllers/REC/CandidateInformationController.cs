...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class CandidateInformationController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../REC/CandidateInformation/Index");
        }
        ...
        {            
            ...
            {
                return PartialView("../REC/CandidateInformation/InputAreasPartial", model);
            }
            else
            {
                return PartialView("../REC/CandidateInformation/_Create", model);
            }
        }
        public ActionResult Tab4ExpectationPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/Tab4ExpectationPartial", model);
        }
        ...
        public ActionResult Tab5WorkingBackgroundPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/Tab5WorkingBackgroundPartial", list);
        }
        public ActionResult _CreateWorkingBackground()
        {
            WorkingBackgroundViewModel model = new WorkingBackgroundViewModel();
            return PartialView("../REC/CandidateInformation/_popupTab5WorkingBackgroundPartial", model);
        }
        ...
        public ActionResult Tab6QualificationPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/Tab6QualificationPartial", list);
        }
        ...
        public ActionResult _popupTab6QualificationPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/_popupTab6QualificationPartial", model);
        }
        ...
        //{
        //    WorkingBackgroundViewModel model = new WorkingBackgroundViewModel();
        //    return PartialView("../REC/CandidateInformation/_popupTab7AttachFilesPartial", model);
        //}
        ...
        public ActionResult Tab7AttachFilesPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/Tab7AttachFilesPartial", documentList);
        }
        ...
        public ActionResult AvatarPartial()
        {
            ...
            return PartialView("../REC/CandidateInformation/AvatarPartial", model);
        }
