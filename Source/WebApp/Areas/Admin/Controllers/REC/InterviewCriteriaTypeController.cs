...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class InterviewCriteriaTypeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../REC/InterviewCriteriaType/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../REC/InterviewCriteriaType/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../REC/InterviewCriteriaType/_List", list);
        }
        public ActionResult _Create()
        {
            REC_tblInterviewCriteriaType model = new REC_tblInterviewCriteriaType();
            model.Used = true;
            return PartialView("../REC/InterviewCriteriaType/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../REC/InterviewCriteriaType/_Create", modelEntity);
        }
        [HttpPost]
