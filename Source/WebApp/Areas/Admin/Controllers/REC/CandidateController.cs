...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class CandidateController : BaseController
    {
        ...
        public PartialViewResult _CandidateBox()
        {
            ...
            return PartialView("../REC/Candidate/_CandidateBox", candidateModel);
        }
        #endregion
        ...
        {
            return PartialView("../REC/Candidate/_PopupCandidatePartial");
        }
        //Vùng nhập dữ liệu search
        public ActionResult _SearchAreasPartial()
        {
            CreateViewBag();
            return PartialView("../REC/Candidate/_SearchAreasPartial");
        }
        ...
        public ActionResult _SearchResultsForPopup(CandidateSearch2ViewModel searchModel)
        {
            ...
            return PartialView("../REC/Candidate/_SearchResultsForPopup", lst);
        }
