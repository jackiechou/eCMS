    ...
    public class ListSocialInsuranceController : BaseController
    {
        ...
        public ActionResult Index(string Mode)
        {
            if (string.IsNullOrEmpty(Mode))
            {
                ...
                {
                    return PartialView("../SI/ListSocialInsurance/_Reset");
                }
                else
                {
                    if (CurrentAcc == null)
                    ...
                    return View("../SI/ListSocialInsurance/Index");
                }
            }
            else
            {
                if (Request.IsAjaxRequest())
                {
                    return PartialView("../SI/ListSocialInsurance/RenewHICard/_HICardReset");
                }
                else
                {
                    if (CurrentAcc == null)
                    ...
                    return View("../SI/ListSocialInsurance/RenewHICard/Index");
                }
            }
        }
        #region Search
        public ActionResult _List(InsuranceInformationSearchViewModel modelSearch)
        {
            ...
            return PartialView("../SI/ListSocialInsurance/_List", list);
        }
        public ActionResult _Create()
        {
            InsuranceInformationSearchViewModel model = new InsuranceInformationSearchViewModel();

            return PartialView("../SI/ListSocialInsurance/_Create", model);
        }
        #endregion
        ...
        {
            return PartialView("../SI/ListSocialInsurance/RenewHICard/_HICardCreate");
        }

        public ActionResult _HICardList()
        {
            List<EmployeeSearchViewModel> list = new List<EmployeeSearchViewModel>();
            return PartialView("../SI/ListSocialInsurance/RenewHICard/_HICardList", list);
        }

        public ActionResult _EmployeeCreatePartial()
        {
            EmployeeSearchViewModel model = new EmployeeSearchViewModel();
            return PartialView("../SI/ListSocialInsurance/RenewHICard/_EmployeeCreatePartial", model);
        }
        ...
        public ActionResult _EmployeeCreateSearchResultPartial(string EmpCode, string FullName, int? SearchLSCompanyID, bool? Searchactive1)
        {
            ...
            return PartialView("../SI/ListSocialInsurance/RenewHICard/_EmployeeCreateSearchResultPartial", Employeelst);
        }
        ...
        public ActionResult _AddEmployeeToList(string EmployeeSelectedList, List<EmployeeSearchViewModel> EmployeeList)
        {
            ...
            return PartialView("../SI/ListSocialInsurance/RenewHICard/_HICardList", EmployeeList);
        }
