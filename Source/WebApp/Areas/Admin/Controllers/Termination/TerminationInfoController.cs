    ...
    public class TerminationInfoController : BaseController
    {
        ...
        {           
            ...
            {              
                ...
                return PartialView("../Termination/TerminationInfo/_SearchResults", sources);
            }
            else
                return View("../Termination/TerminationInfo/Index");                    
        }
         ...
         public ActionResult GetTerminationList(int? Type)
         {
             ...
             return PartialView("../Termination/TerminationInfo/_TerminationList", lst);
         }
         ...
         public ActionResult _SearchForm()
         {
             ...
             {
                 return PartialView("../Termination/TerminationInfo/_SearchForm");
             }
             else
             {
        ...
        {
            return PartialView("../Termination/TerminationInfo/_ConfirmationPopup");
        }
        #endregion
        ...
        public ActionResult CreateDownloadLink(int? FileId)
        {
            ...
            return PartialView("../Termination/TerminationInfo/_DownloadLink", DownloadFileLink);
        }
        ...
        public ActionResult GetTerminationInfoOfEmployee(int? EmpID)
        {
            ...
            return PartialView("../Termination/TerminationInfo/_EmployeeTermination", entity);
        }
        ...
        //    return View("../Termination/TerminationInfo/_Create", model);           
        //}
        ...
        public PartialViewResult Create(int? TerminationID, int? EmpID)
        {
            ...
            return PartialView("../Termination/TerminationInfo/_Create", entity);
        }
        ...
        public ActionResult LoadCreateForm()
        {
            ...
            PopulateTerminationTypesToDropDownList(true, null);
            PopulateTerminationReasonsToDropDownList(true, null);
            return PartialView("../Termination/TerminationInfo/_Edit", entity);
        }
        ...
        public ActionResult List()
        {
            ...
            return PartialView("../Termination/TerminationInfo/_SearchResults", lst);
        }     
