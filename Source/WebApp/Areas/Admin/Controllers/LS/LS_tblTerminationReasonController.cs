    ...
    public class LS_tblTerminationReasonController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (acc != null)
            {
                if (Request.IsAjaxRequest())
                    return PartialView("../Termination/TerminationReason/_Reset");
                else
                    return View("../Termination/TerminationReason/Index");
            }else
            {
        ...
        public ActionResult List()
        {
            ...
            if (acc != null)
            {
                ...
                return PartialView("../Termination/TerminationReason/_List", sources);
            }
            else
            {
                Response.RedirectToRoute("Admin_Login");
        ...
        public ActionResult Create()
        {
            if (Session[SettingKeys.AccountInfo] != null)
            {
                ...
                return PartialView("../Termination/TerminationReason/_Edit", model);
            }
            else
            {
                Response.RedirectToRoute("Admin_Login");
