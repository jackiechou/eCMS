    ...
    public class LS_tblTerminationTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            if (Session[SettingKeys.AccountInfo] != null)
            {
                if (Request.IsAjaxRequest())
                    return PartialView("../Business/HumanResources/Termination/TerminationType/_Reset");
                else
                    return View("../Business/HumanResources/Termination/TerminationType/Index");
            }
            else
            {
        ...
        public ActionResult List()
        {
            ...
            if (acc != null)
            {
                ...
                return PartialView("../Business/HumanResources/Termination/TerminationType/_List", sources);
            }
            else
            {
                Response.RedirectToRoute("Admin_Login");
        ...
        public ActionResult Create()
        {
            if (Session[SettingKeys.AccountInfo] != null)
            {
                ...
                return PartialView("../Business/HumanResources/Termination/TerminationType/_Edit", model);
            }
            else
            {
                Response.RedirectToRoute("Admin_Login");
