...
{
    public class LS_tblTrainingTypeController : BaseController
    {
        //
        // GET: /Admin/LS_tblTrainingType/
        ...
        public ActionResult Index()
        {
            ...
            LS_tblTrainingTypeRepository _repository = new LS_tblTrainingTypeRepository(db);
            IList<LS_tblTrainingTypeViewModel> sources = _repository.List().ToList();
            return View(sources);
        }


        [HttpPost]
        public ActionResult Save(LS_tblTrainingTypeViewModel model)
        {
            AccountViewModel acc = (AccountViewModel)Session[SettingKeys.AccountInfo];
            string errorMessage = "";
            if (acc != null)
        ...
        [HttpPost]
        public ActionResult Update(LS_tblTrainingTypeViewModel model)
        {
            LS_tblTrainingTypeRepository _repository = new LS_tblTrainingTypeRepository(db);
        ...
        public ActionResult _Error(LS_tblTrainingTypeViewModel model, string ErrorMessage)
        {
            if (model == null)
            {
                model = new LS_tblTrainingTypeViewModel();
            }
            ...
            return PartialView("../HR_MasterData/_LS_tblTrainingTypeCreate", model);
        }
        ...
        {
            var list = db.LS_tblTrainingType
            ...
            list.Insert(0, new LS_tblTrainingTypeViewModel() { LSTrainingTypeID = 0, Name = " --- " + @Eagle.Resource.LanguageResource.Select + " --- " });
