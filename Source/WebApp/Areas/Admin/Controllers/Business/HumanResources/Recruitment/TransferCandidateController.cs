...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TransferCandidateController : BaseController
    {
        ...
        public ActionResult Index(string mode = "search", TransferCandidateViewModel modelSearch = null, int? CandidateID = null)
        {
            ...
            if (mode == "edit")
            {
                return View("../Business/HumanResources/REC/TransferCandidate/Edit/Edit");
            }
            else
            {
                if (modelSearch == null)
                ...
                return View("../Business/HumanResources/REC/TransferCandidate/Index");
            }
        }
        ...
        public ActionResult _Create(TransferCandidateViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/REC/TransferCandidate/_Create", model);
        }
        ...
        public ActionResult _Edit(int CandidateID, TransferCandidateViewModel TransferCandidate)
        {
            ...
            return PartialView("../Business/HumanResources/REC/TransferCandidate/Edit/_Edit", model);
        }
        ...
        public ActionResult _List(TransferCandidateViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/REC/TransferCandidate/_List", result);
        }
        [HttpPost]
