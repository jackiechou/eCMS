...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class CandidateListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/REC/CandidateList/Index");
        }

        public ActionResult _Create()
        {
            CreateViewBag();
            return PartialView("../Business/HumanResources/REC/CandidateList/_Create");
        }
        ...
        public ActionResult _List(CandidateSearchViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateList/_List", result);
        }
        [HttpPost]
