    ...
    public class CandidateTournamentController : BaseController
    {
        ...
        public ActionResult Index(int? ProjectTournamentID = null, int? CandidateID = null, string mode = "search", ResultsRecordSearchViewModel ParamSearch = null)
        {
            ...
            if (mode == "search")
            {
                ...
                return View("../Business/HumanResources/REC/CandidateTournament/Index");
            }
            //Edit
            else
            {
                ...
                return View("../Business/HumanResources/REC/CandidateTournament/Edit/Edit");
            }
        ...
        public ActionResult _Create(ResultsRecordSearchViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/_Create", model);
        }
        ...
        public ActionResult _List(ResultsRecordSearchViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/_List", list);
        }
       //Tạo viewbag cho search box
        ...
        public ActionResult _ModifiCandidateTournament(int? CandidateID = null, int? ProjectTournamentID = null)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_ModifiCandidateTournament", candidateTournamentmodel);
        }
        ...
        public ActionResult _PreviousRoundInfo(int? CandidateID, int? ProjectTournamentID)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_PreviousRoundInfo", listModel);
        }
        ...
        public ActionResult _Error(CandidateTournamentViewModel model, string ErrorMessage)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_ModifiCandidateTournament", model);
        }
        #endregion
        ...
        { 
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_CandidateInfomation", candidate);
        }
        #endregion
        ...
        public ActionResult _WorkingBackGround(int? CandidateID)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_WorkingBackGround", list);
        }
        //View
        ...
        public ActionResult _popupWorkingBackground(int WorkingBackgroundId)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_popupWorkingBackground", model);
        }
        #endregion
        ...
        public ActionResult _Qualification(int? CandidateID)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_Qualification", list);
        }
        //View
        public ActionResult _popupQualification(int QualificationId)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_popupQualification", model);
        }
        ...
        public ActionResult _AttachFile(int? CandidateID)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_AttachFile", documentList);
        }
        //View
        public ActionResult _popupAttachFile(int DocumentId)
        {
            ...
            return PartialView("../Business/HumanResources/REC/CandidateTournament/Edit/_popupAttachFile", document);
        }
        #endregion
