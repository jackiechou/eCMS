...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentTypeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentType/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/RecruitmentType/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentType/_List", list);
        }
        public ActionResult _Create()
        {
            LS_tblRecruitmentType model = new LS_tblRecruitmentType();
            model.Used = true;
            return PartialView("../Business/HumanResources/REC/RecruitmentType/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentType/_Create", modelEntity);
        }
        [HttpPost]
