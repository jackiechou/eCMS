...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class QuotaRecruitmentController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/QuotaRecruitment/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/QuotaRecruitment/Index");
            }
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/REC/QuotaRecruitment/_Create", model);
        ...
        public ActionResult _List()
        {
            ...
            //return PartialView("../Business/HumanResources/REC/WorkingBackground/_List", list);
            return null;
        }
        public ActionResult AddToGrid(QuotaRecruitmentCreateViewModel model, List<QuotaRecruitmentViewModel> list)
        {
            ...
            if (ModelState.IsValid)
            {
                                ...
                                p.LSPositionID == model.LSPositionIDSearch).FirstOrDefault() == null)
                {
                    ...
                    return PartialView("../Business/HumanResources/REC/QuotaRecruitment/_List", list);
                }
                else
                {
