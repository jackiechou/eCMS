...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentFeeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentFee/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/RecruitmentFee/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentFee/_List", list);
        }
        public ActionResult _Create()
        {
            LS_tblRecruitmentFee model = new LS_tblRecruitmentFee();
            model.Used = true;
            return PartialView("../Business/HumanResources/REC/RecruitmentFee/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentFee/_Create", modelEntity);
        }
        [HttpPost]
