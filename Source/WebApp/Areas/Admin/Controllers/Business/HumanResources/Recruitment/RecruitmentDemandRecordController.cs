...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentDemandRecordController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/REC/RecruitmentDemandRecord/Index");
        }
        public ActionResult _Create()
        {
            ...
            CreateStatusViewBag();
            return PartialView("../Business/HumanResources/REC/RecruitmentDemandRecord/_Create", model);
        }
        ...
        public ActionResult _List(int? Year, int? LSCompanyID, int? LSPositionID, int? StatusDemand)
        {
            if (CurrentAcc != null)
            {
                ...
                return PartialView("../Business/HumanResources/REC/RecruitmentDemandRecord/_List", List);
            }
            else
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentDemandRecord/_List");
            }
        }
