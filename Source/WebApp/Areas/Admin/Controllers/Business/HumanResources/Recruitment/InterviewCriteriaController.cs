...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class InterviewCriteriaController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/InterviewCriteria/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/InterviewCriteria/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/REC/InterviewCriteria/_List", list);
        }
        public ActionResult _Create()
        {
            InterviewCriteriaViewModel model = new InterviewCriteriaViewModel();
            model.Used = true;
            return PartialView("../Business/HumanResources/REC/InterviewCriteria/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/REC/InterviewCriteria/_Create", modelEntity);
        }
        [HttpPost]
