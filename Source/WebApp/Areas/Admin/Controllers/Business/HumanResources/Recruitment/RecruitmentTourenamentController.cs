...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentTournamentController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentTournament/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/RecruitmentTournament/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentTournament/_List", list);
        }
        public ActionResult _Create()
        {
            LS_tblRecruitmentTournament model = new LS_tblRecruitmentTournament();
            model.Used = true;
            return PartialView("../Business/HumanResources/REC/RecruitmentTournament/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentTournament/_Create", modelEntity);
        }
        [HttpPost]
