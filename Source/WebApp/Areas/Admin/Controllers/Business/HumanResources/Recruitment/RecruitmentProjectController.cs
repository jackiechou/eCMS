...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class RecruitmentProjectController : BaseController
    {
        ...
        public ActionResult Index(int? ProjectID,string mode)
        {
            ...
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentProject/_Reset", modelEdit);
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/REC/RecruitmentProject/Index", modelEdit);
            }
        }
        ...
        public ActionResult _Create(RecruitmentProjectViewModel model, string mode)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_Create", model);
        }
        ...
        public ActionResult _RecruitmentTournamentCreatePartial(int? ProjectTournamentID)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentCreatePartial", model);
        }
        ...
        public ActionResult _AddRecruitmentTournamentToList(ProjectTournamentViewModel model, string mode, int? OldSEQ, List<ProjectTournamentViewModel> ProjectTournamentList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentListPartial", ProjectTournamentList.OrderBy( p => p.SEQ));
        }
        ...
        public ActionResult _DeleteTournament(int SEQ,List<ProjectTournamentViewModel> ProjectTournamentList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentListPartial", ProjectTournamentList);
        }
        ...
        public ActionResult _EditTournament(int SEQ, List<ProjectTournamentViewModel> ProjectTournamentList)
        {
            ...
            if (modelEdit != null)
            {
                ...
                return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentCreatePartial", modelEdit);
            }
            else
            {
        ...
        public ActionResult _RecruitmentTournamentListPartial(List<ProjectTournamentViewModel> lst)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentListPartial", lst.OrderBy(p => p.SEQ));
        }
        #endregion
        #region Candidate
        ...
        public ActionResult _CandidateListPartial(List<CandidateResultViewModel> lst)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_CandidateListPartial", lst);
        }
        ...
        public ActionResult _CandidateCreatePartial()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_CandidateCreatePartial", model);
        }
        ...
        public ActionResult _CandidateCreateSearchResultPartial(CandidateSearchViewModel model, string CandidateSelectedList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_CandidateCreateSearchResultPartial", result);
        }
        ...
        public ActionResult _AddCandidateToList(string CandidateListAdd, List<CandidateResultViewModel> CandidateList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_CandidateListPartial", CandidateList);
        }
        ...
        public ActionResult _ListOfRecruitmentDemandPartial(List<RecruitmentDemandResultViewModel> lst)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_ListOfRecruitmentDemandPartial", lst);
        }
        /*Khung nhập dữ liệu tìm kiếm*/
        public ActionResult _DemandCreatePartial()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentDemandCreatePartial", model);
        }
        /*Nhấn nút search candidate*/
        public ActionResult _DemandCreateSearchResultPartial(int? Year, int? LSCompanyID, int? LSPositionID, string DemandSelectedList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentDemandCreateSearchResultPartial", List);
        }
        ...
        public ActionResult _AddDemandToList(string DemandListAdd, List<RecruitmentDemandResultViewModel> DemandList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_ListOfRecruitmentDemandPartial", DemandList);
        }
        ...
        public ActionResult _FeeCreatePartial()
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_FeeCreatePartial", model);
        }
        /*Danh sách chi phí*/
        public ActionResult _FeeListPartial(List<ProjectFeeViewModel> lst)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_FeeListPartial", lst);
        }
        ...
        public ActionResult _AddFeeToList(ProjectFeeViewModel model, string mode, int? OldLSRecruitmentFeeID, List<ProjectFeeViewModel> ProjectFeeList)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_FeeListPartial", ProjectFeeList);
        }
        ...
        public ActionResult _EditFee(int LSRecruitmentFeeID, List<ProjectFeeViewModel> ProjectFeeList)
        {
            ...
            if (modelEdit != null)
            {
                return PartialView("../Business/HumanResources/REC/RecruitmentProject/_FeeCreatePartial", modelEdit);
            }
            else
            {
                return Content("CouldNotFound");
        ...
        private ActionResult _ProjectFeeError(ProjectFeeViewModel model, string ErrorMessage)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_FeeCreateFormInnerPartial", model);
        }
       ...
       private ActionResult _ProjectTournamentError(ProjectTournamentViewModel model, string ErrorMessage)
        {
            ...
            return PartialView("../Business/HumanResources/REC/RecruitmentProject/_RecruitmentTournamentCreateFormInnerPartial", model);
        }
