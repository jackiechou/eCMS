...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class InsNoticeDataController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/SecurityInsurance/InsNoticeData/Index");
        }
        public ActionResult _SearchHeaderEmp()
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/InsNoticeData/_HeaderSearchEmp");
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/InsNoticeData/_List", sources);
        }
        public ActionResult _Search(InsNoticeDataCreateViewModels model, string Status, int ModuleID)
        {
            ...
            else
            {
                ...
                return PartialView("../Business/HumanResources/SecurityInsurance/InsNoticeData/_ListSearch", sources_search);
            }
