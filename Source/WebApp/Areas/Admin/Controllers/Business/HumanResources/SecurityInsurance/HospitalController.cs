...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class HospitalController : BaseController
    {
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/SecurityInsurance/Hospital/_Reset");
            }
            else
            {
                if (CurrentAcc == null)
                ...
                return View("../Business/HumanResources/SecurityInsurance/Hospital/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/Hospital/_List", list);
        }
        public ActionResult _Create()
        {
            HospitalViewModel model = new HospitalViewModel();
            model.Used = true;
            return PartialView("../Business/HumanResources/SecurityInsurance/Hospital/_Create", model);
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/Hospital/_Create", modelEntity);
        }
        [HttpPost]
