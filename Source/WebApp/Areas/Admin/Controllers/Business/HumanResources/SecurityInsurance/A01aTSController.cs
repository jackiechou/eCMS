...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class A01aTSController : BaseController
    {
        ...
        {
            return View("../Business/HumanResources/SecurityInsurance/A01aTS/Index");
        }
        public ActionResult _Create()
        {
            ...
            //Return
            return PartialView("../Business/HumanResources/SecurityInsurance/A01aTS/_Create", model);
        }
        ...
        public ActionResult ReportViewerPartial(C66ASearchViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/A01aTS/ReportViewerPartial");
        }
