...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class C70AController : BaseController
    {
        ...
        {
            return View("../Business/HumanResources/SecurityInsurance/C70A/Index");
        }
        ...
        public ActionResult _Create()
        {
            ...
            //Return
            return PartialView("../Business/HumanResources/SecurityInsurance/C70A/_Create", model);
        }
        ...
        public ActionResult ReportViewerPartial(C66ASearchViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/C70A/ReportViewerPartial");
        }
