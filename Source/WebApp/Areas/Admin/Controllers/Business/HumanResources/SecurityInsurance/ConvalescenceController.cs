...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class ConvalescenceController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/SecurityInsurance/Convalescence/Index");
        }

        public ActionResult _CreateDataPartial()
        {
            ConvalescenceSearchViewModel model = new ConvalescenceSearchViewModel();
            return PartialView("../Business/HumanResources/SecurityInsurance/Convalescence/_CreateDataPartial", model);
        }
        public ActionResult _SearchPartial()
        {
            ConvalescenceSearch2ViewModel model = new ConvalescenceSearch2ViewModel();
            return PartialView("../Business/HumanResources/SecurityInsurance/Convalescence/_SearchPartial", model);
        }

        public ActionResult _Create()
        {
            ConvalescenceViewModel model = new ConvalescenceViewModel();
            return PartialView("../Business/HumanResources/SecurityInsurance/Convalescence/_Create", model);
        }

        public ActionResult _List()
        {
            List<ConvalescenceViewModel> List = new List<ConvalescenceViewModel>();
            return PartialView("../Business/HumanResources/SecurityInsurance/Convalescence/_List", List);
        }
        ...
        public ActionResult Search(ConvalescenceSearch2ViewModel model)
        {
            ...
            return PartialView("../Business/HumanResources/SecurityInsurance/Convalescence/_SearchResultList", List);
        }
