...
{
    public class C68AController : BaseController
    {
        //
        // GET: /Admin/C68A/
        ...
        {
            return View("../Business/HumanResources/SecurityInsurance/C68A/Index");
        }
        ...
        public ActionResult _Create()
        {
            ...
            //Return
            return PartialView("../Business/HumanResources/SecurityInsurance/C68A/_Create", model);
        }
        ...
        public ActionResult ReportViewerPartial(C66ASearchViewModel model)
        {
            ...
            ViewData["Report"] = new C68AXtraReport();
            return PartialView("../Business/HumanResources/SecurityInsurance/C68A/ReportViewerPartial");
        }
        ...
        {
            C68AXtraReport report = CreateReport(model);
            return DevExpress.Web.Mvc.ReportViewerExtension.ExportTo(report);
        }
        private C68AXtraReport CreateReport(C66ASearchViewModel model)
        {

            C68AXtraReport report = new C68AXtraReport();
            ...
            report.Name = "C68A-HD - Danh sach nguoi lao dong de nghi huong tro cap nghi DSPHSK sau om " + "K" + model.Stage.ToString() + "-T" + model.SIMonth.Replace("/", "-");
            return report;
        }
