...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class AnswerTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/AnswerType/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/AnswerType/Index");
            }
        }        
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/AnswerType/_List", result);            
        }
        ...
        public ActionResult _Create()
        {
            ...
            model.Used = true;
            return PartialView("../Business/HumanResources/Training/AnswerType/_Create", model);
        }
