    ...
    public class TrainingRequestController : BaseController
    {
        ...
        public ActionResult _ListOfDuration(int? TrainingRequestID)
        {
            ...
            if (TrainingRequestID.HasValue && TrainingRequestID.Value > 0)
            {
                ...
                return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_ListOfDuration", listOfDuration);
            }            
        ...
        public ActionResult _ListOfDurationUser(int? TrainingRequestID)
        {
            ...
            if (TrainingRequestID.HasValue && TrainingRequestID.Value > 0)
            {
                ...
                this.TempData["DurationUser"] = listOfDurationUser;
                return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_ListOfEmployeeDuration", listOfDurationUser);
            }
            this.TempData["DurationUser"] = listOfDurationUser;
        ...
        {
            return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_CreateCost", new TrainingRequestCostViewModel());
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {            
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_ListOfCost", listOfCost);
        }
        ...
        public ActionResult AddRowOfCost(TrainingRequestCostViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_ListOfCost", listOfExpense);
        }
        ...
        public ActionResult Index(int? TrainingRequestID, int? TrainingPlanID)
        {
            if (TrainingRequestID.HasValue && TrainingRequestID.Value > 0)
            {
                ...
                return View("../Business/HumanResources/Training/TrainingRequest/Edit", TrainingRequestID);
            }
            else
            {
                if (Request.IsAjaxRequest())
                {
                    return PartialView("../Business/HumanResources/Training/TrainingRequest/_Reset", TrainingPlanID);
                }
                else
                {
                    if (CurrentAcc == null)
                    ...
                    return View("../Business/HumanResources/Training/TrainingRequest/Index", TrainingPlanID);
                }
            }               
        }
        ...
        public ActionResult _Create(int? TrainingPlanID)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_Create", request);
        }
        ...
        public ActionResult _popupUnapprove(int LevelApprove)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_popupUnapprove");
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_Create", model);
        }
        ...
        public ActionResult GetValueOfTrainingExpense(int LSTrainingExpenseID, string value)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingRequest/_ListOfCost", listOfTrainingCost);
        }
        ...
        {
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_SearchAreasPartial");
        }
        ...
        {
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_PopupEmployeePartial");
        }
        ...
        public ActionResult _SearchResultsForPopupTrainingRequest(string EmpCode, string FullName, int? LSCompanyID, int? moduleId)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingRequest/_SearchResultsForPopupTrainingRequest", Employeelst);
        }
        #endregion
    }
}
