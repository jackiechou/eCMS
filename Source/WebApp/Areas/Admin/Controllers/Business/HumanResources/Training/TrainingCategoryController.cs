...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingCategoryController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingCategory/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingCategory/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingCategory/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingCategory/_Create", model);
        }
