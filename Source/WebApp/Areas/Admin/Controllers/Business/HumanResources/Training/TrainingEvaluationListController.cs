...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingEvaluationListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingEvaluationList/_Reset");
            }
            else
            {
                ...
                return View("../Business/HumanResources/Training/TrainingEvaluationList/Index");
            }            
        }
        ...
        public ActionResult _Create(TrainingEvaluationViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingEvaluationList/_Create", model);
        }
        ...
        public ActionResult _Edit(int TrainingEvaluationID)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingEvaluation/_Create", model);
        }
        ...
        public ActionResult _List(TrainingEvaluationViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingEvaluationList/_List", result);
        }          
        ...
        public ActionResult _Error(TrainingEvaluationViewModel model, string ErrorMessage)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingEvaluationList/_Create", model);
        }        
    }
}
