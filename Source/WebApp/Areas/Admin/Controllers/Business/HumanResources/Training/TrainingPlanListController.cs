...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingPlanListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingPlanList/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingPlanList/Index");
            }
        }
        ...
        public ActionResult _List(TrainingPlanSearchViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingPlanList/_List", result);
        }
        ...
        {
            this.CreateViewBag();                        
            return PartialView("../Business/HumanResources/Training/TrainingPlanList/_Create", new TrainingPlanSearchViewModel());
        }        
        ...
        public ActionResult _Error(TrainingPlanSearchViewModel model, string ErrorMessage)
        {
            ...
            this.CreateViewBag();
            return PartialView("../Business/HumanResources/Training/TrainingPlanList/_Create", model);
        }          
    }
}
