...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingFormController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingForm/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingForm/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingForm/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingForm/_Create", model);
        }
