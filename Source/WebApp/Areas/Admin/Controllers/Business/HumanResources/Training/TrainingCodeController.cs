...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingCodeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingCode/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingCode/Index");
            }
        }        
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingCode/_List", result);            
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingCode/_Create", model);
        }
