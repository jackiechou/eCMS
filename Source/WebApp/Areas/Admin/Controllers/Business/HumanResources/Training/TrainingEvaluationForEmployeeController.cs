    ...
    public class TrainingEvaluationForEmployeeController : BaseController
    {
        ...
        public ActionResult Index(string Mode, int? TrainingEvaluationID, int? TrainingRequestID)
        {
            if (string.IsNullOrEmpty(Mode))
            {
                ...
                {
                    return this.PartialView("../Business/HumanResources/Training/TrainingEvaluationForEmployee/_Reset");
                }
                else
                {
                    ...
                    return this.View("../Business/HumanResources/Training/TrainingEvaluationForEmployee/Index");
                }
            }
            else
            {
                ...
                {
                    return this.View("../Business/HumanResources/Training/TrainingEvaluationForEmployee/TrainingEvaluation/Index", TrainingRequestID);
                }
                else
                {
                    return this.View("../Business/HumanResources/Training/TrainingEvaluationForEmployee/TrainingEvaluation/Edit", TrainingEvaluationID);
                }
        ...
        public ActionResult Create()
        {
            ...
            this.CreateViewBag();
            return this.PartialView("../Business/HumanResources/Training/TrainingEvaluationForEmployee/_Create", model);             
        }
        ...
        public ActionResult List(TrainingRequestSearchViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingEvaluationForEmployee/_List", listOfTrainingRequest);
        }
        ...
        public ActionResult Error(TrainingEvaluationForEmployeeViewModel model, string ErrorMessage)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingEvaluationForEmployee/_Create", model);
        }
