...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingCourseController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingCourse/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingCourse/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingCourse/_List", result);
        }
        ...
        {            
            return PartialView("../Business/HumanResources/Training/TrainingCourse/_Create", new TrainingCourseViewModel());
        }
        ...
        public ActionResult _Edit(int id)
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingCourse/_Create", model);
        }
