...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingRequestListController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingRequestList/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingRequestList/Index");
            }
        }
        ...
        public ActionResult _List(TrainingRequestSearchViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingRequestList/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingRequestList/_Create", request);
        }
        ...
        public ActionResult _Error(TrainingRequestSearchViewModel model, string ErrorMessage)
        {
            ...
            this.CreateViewBag();
            return PartialView("../Business/HumanResources/Training/TrainingRequestList/_Create", model);
        }        
    }
}
