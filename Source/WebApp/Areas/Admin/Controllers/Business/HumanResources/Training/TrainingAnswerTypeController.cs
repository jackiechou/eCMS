...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TrainingAnswerTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingAnswerType/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingAnswerType/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingAnswerType/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingAnswerType/_Create", model);
        }
