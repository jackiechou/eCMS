...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    {        
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Business/HumanResources/Training/TrainingPlanExpenseReport/Reset");
            }
            else
            {
                return this.View("../Business/HumanResources/Training/TrainingPlanExpenseReport/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingPlanExpenseReport/Create", model);
        }
        ...
        public ActionResult Report(TR_sprptTrainingPlanExpense_Result model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingPlanExpenseReport/TrainingPlanExpenseReportViewer");
        }
        ...
        {                        
            ...
            return PartialView("../Business/HumanResources/Training/TrainingPlanExpenseReport/TrainingPlanExpenseReportViewer");
        }
