...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    {        
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Business/HumanResources/Training/TrainingPlanEvaluationReport/Reset");
            }
            else
            {
                return this.View("../Business/HumanResources/Training/TrainingPlanEvaluationReport/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingPlanEvaluationReport/Create", model);
        }
        ...
        public ActionResult Report(TrainingPlanEvaluationResultViewModel model, int? EvaluationRequired, int? EmployeeEvaluation)
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingPlanEvaluationReport/TrainingPlanEvaluationReportViewer");
        }
        ...
        {                        
            ...
            return PartialView("../Business/HumanResources/Training/TrainingPlanEvaluationReport/TrainingPlanEvaluationReportViewer");
        }
