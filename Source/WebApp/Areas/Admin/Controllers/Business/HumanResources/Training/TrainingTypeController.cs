...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    public class TrainingTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/TrainingType/_Reset");
            }
            else
            {
                return View("../Business/HumanResources/Training/TrainingType/Index");
            }
        }
        ...
        public ActionResult _List()
        {
            ...
            return this.PartialView("../Business/HumanResources/Training/TrainingType/_List", result);
        }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Training/TrainingType/_Create", model);
        }
