...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class EvaluationTemplateListController : BaseController
    {
        ...
        public ActionResult Index(int? EvaluationTemplateID)
        {
            ...
            {
                return PartialView("../Business/HumanResources/Training/EvaluationTemplateList/_Reset");
            }
            else
            {
                ...
                return View("../Business/HumanResources/Training/EvaluationTemplateList/Index");
            }            
        }
        ...
        {
            this.CreateViewBag();
            return this.PartialView("../Business/HumanResources/Training/EvaluationTemplateList/_Create", model);
        }
        ...
        public ActionResult _List(EvaluationTemplateViewModel model)
        {
            ...
            this.CreateViewBag();
            return this.PartialView("../Business/HumanResources/Training/EvaluationTemplateList/_List", result);
        }
        ...
        public ActionResult _Error(EvaluationTemplateViewModel model, string ErrorMessage)
        {
            ...
            this.CreateViewBag();
            return PartialView("../Business/HumanResources/Training/EvaluationTemplateList/_Create", model);
        }        
    }
}
