...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TimeKeepingReportController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Business/HumanResources/Timesheet/TimeKeepingReport/Reset");
            }
            else
            {
                return this.View("../Business/HumanResources/Timesheet/TimeKeepingReport/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/TimeKeepingReport/Create", model);
        }
        ...
        public ActionResult Report(TimeKeepingReportViewModel model)
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/TimeKeepingReport/TimeKeepingReportViewer");
        }
