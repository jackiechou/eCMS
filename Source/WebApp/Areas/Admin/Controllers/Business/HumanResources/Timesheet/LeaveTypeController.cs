...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class LeaveTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Timesheet/LeaveType/_Index");
            }
            else
            {
                return View("../Business/HumanResources/Timesheet/LeaveType/Index");
            }
        ...
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/LeaveType/_Create", model);
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/LeaveType/_List", sources);
        }
