...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    {        
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Business/HumanResources/Timesheet/OTNightRecord/Reset");
            }
            else
            {
                return this.View("../Business/HumanResources/Timesheet/OTNightRecord/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/OTNightRecord/Create", model);
        }
        ...
        public ActionResult Report(Timesheet_sprptOTRecord_Detail_Result model, int? Month, int? Year)
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/OTNightRecord/OTNightRecordReportViewer");
        }
