...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class MTLChildController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/Timesheet/MTLChild/Index");
        }
        /// <summary>
        ...
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/MTLChild/_List", sources);
        }
        ...
        {
            return PartialView("../Business/HumanResources/Timesheet/MTLChild/_HeaderSearchEmp");
        }
        public ActionResult _CreateError(List<MTLChildListViewModel> model, string ErrorMessage)
        {
            ...
            return View("../Business/HumanResources/Timesheet/MTLChild/Index", model);
