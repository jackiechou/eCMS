...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class AssignStaffScheduleController : BaseController
    {
        ...
        {
            return View("../Business/HumanResources/Timesheet/AssignStaffSchedule/Index");
        }
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/AssignStaffSchedule/_Create");
        }
