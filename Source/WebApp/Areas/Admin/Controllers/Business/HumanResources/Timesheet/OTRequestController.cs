...
namespace Eagle.WebApp.Areas.Admin.Controllers.Timesheet
{
    public class OTRequestController : BaseController
    {
        ...
        public ActionResult Index( int? OTRecordID)
        {
            ...
            if (OTRecordID == null)
            {
                return View("../Business/HumanResources/Timesheet/OTRequest/Index");
            }
            else
            {
                return View("../Business/HumanResources/Timesheet/OTRequest/Edit", OTRecordID);
            }
        }
        public ActionResult List()
        {
            return View("../Business/HumanResources/Timesheet/OTRequest/ListRecord");
        }
        public ActionResult _ListRecord(OTRequestViewModel model, int? ModuleID = 9)
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_ListRecord", sources);
        }
        public ActionResult _Search()
        {
            ViewBag.Year = System.DateTime.Now.Year;
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_InputSearch");
        }
        // load thông tin 
        public ActionResult _Create(int? iYear)
        {
            ...
            if (acc.FAdm == 1 && (acc.EmpId == null || acc.EmpId == 0))
                ...
                CreateViewBag();
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_Create", null);
        }
        /// <summary>
        ...
        public ActionResult _ViewDetail(int OTRecordID)
        {
            ...
            #endregion
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_Create", modelEdit);
        }
        public ActionResult _ViewListDetail(int OTRecordID)
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_List", Sources);
        }
        /// <summary>
        ...
        public ActionResult _AddRow(List<OTRequestListViewModel>  listModel)
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/OTRequest/_List", listModel);        
        }
        /// <summary>
        /// Xoa dong tren luoi
        /// </summary>
        ...
        public ActionResult _DeleteRow(List<OTRequestListViewModel> listModel)
        {
            ...
            if (acc != null)
            {
                return PartialView("../Business/HumanResources/Timesheet/OTRequest/_List", listModel.Where(p => p.chkCheck == false).ToList());
            }
            else
            {
        ...
        public ActionResult _FillToilAndCash(List<OTRequestListViewModel> lstModel, OTRequestViewModel modelMaster)
        {
            ...
            if (acc != null)
            {
                if (ModelState.IsValid)
                {
                    ...
                    return PartialView("../Business/HumanResources/Timesheet/OTRequest/_List", lstModelUdpate);
                }
        ...
        public ActionResult _CreateError(OTRequestViewModel model, string ErrorMessage)
        {
            ...
            //return PartialView("../Business/HumanResources/Timesheet/OTRequest/_Create", model);
            return Content(ErrorMessage);
