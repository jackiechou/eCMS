...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class LeaveDayTypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("../Business/HumanResources/Timesheet/LeaveDayType/_Index");
            }
            else
            {
                return View("../Business/HumanResources/Timesheet/LeaveDayType/Index");
            }
        }
        public ActionResult _Create()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/LeaveDayType/_Create", model);
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/LeaveDayType/_List", sources);
        }
