...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    public class TimekeepingController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("../Business/HumanResources/Timesheet/Timekeeping/Index");
        }
        public ActionResult _List()
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/Timekeeping/_List", sources);
        }
        public ActionResult _SearchHeaderEmp()
        {
            return PartialView("../Business/HumanResources/Timesheet/Timekeeping/_HeaderSearchEmp");
        }
        public ActionResult _CreateError(TimekeepingSearchViewModel model, string ErrorMessage)
        {
            ...
            return View("../Business/HumanResources/Timesheet/Timekeeping/Index", model);
        ...
        public ActionResult _PopupEditTimeKeeping(int EmpID, string MMYYYY)
        {
            ...
            return PartialView("../Business/HumanResources/Timesheet/Timekeeping/_PopupEditTimeKeeping",sources);
        }
        ...
        public ActionResult _PopupEditTimeKeepingFormInner(int EmpID, string MMYYYY)
        {
            TimekeepingRepository _repository = new TimekeepingRepository(db);
            List<TimekeepingListViewModel> sources = _repository._ListPopup(MMYYYY, EmpID);
            return PartialView("../Business/HumanResources/Timesheet/Timekeeping/_PopupEditTimeKeepingFormInner", sources);
        }  
