...
namespace Eagle.WebApp.Areas.Admin.Controllers
{
    ...
    {        
        ...
        public ActionResult Index()
        {
            ...
            {
                return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/Reset");
            }
            else
            {
                return this.View("../Business/HumanResources/Timesheet/OTRecord/Index");
            }
        ...
        public ActionResult Create()
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/Create", model);
        }
        ...
        public ActionResult Report(Timesheet_sprptOTRecord_Result model, int? Month, int? Year)
        {
            ...
            return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/OTRecord31ReportViewer");
        }
        ...
        {                        
            ...
            if (numberOfDays == 30)
            {
                ...
                return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/OTRecord30ReportViewer");
            }
            if (numberOfDays == 29)
            {
                this.ViewData["Report"] = this.CreateOTRecord29Report(model);
                return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/OTRecord29ReportViewer");
            }
            if (numberOfDays == 28)
            {
                this.ViewData["Report"] = this.CreateOTRecord28Report(model);
                return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/OTRecord28ReportViewer");
            }
            this.ViewData["Report"] = new OTRecord31XtraReport();
            return this.PartialView("../Business/HumanResources/Timesheet/OTRecord/OTRecord31ReportViewer");
        }        
