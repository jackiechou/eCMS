...
function DrawLineChart(chartPlaceholder, data, chartLabel, xAxisLabel, yAxisLabel) {
    ...
    //var legendContainer = $('<div id="legendContainer"></div>').css({
    ...
    //    opacity: 0.9
    //}).insertBefore("#ChartPlaceholder").fadeIn(200);
            ...
            pie: {
                ...
                label: {
                    ...
                    formatter: function (label, series) {
                        ...
                        return '<div style="border:1px solid grey;font-size:8pt;text-align:center;padding:5px;color:white;">' + series.percent + '%</div>';
                    },
                    background: {
                        opacity: 0.5,
                        color: '#000'
