...
namespace Eagle.Common.Settings
{
    public class Config
    {
        ...
        {
            string backupFolder = SystemSettings.glbConfigFolder + "Backup_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + "\\";

            //save the current config files
            try
            {
                Eagle.Common.Application.Application app = new Eagle.Common.Application.Application();
        ...
        {
            string backupFolder = SystemSettings.glbVersionConfigFolder + "BackupVersion_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + "\\";
        ...
        {
            string backupFolder = SystemSettings.glbConnStringConfigFolder + "BackupConnString_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + "\\";
        ...
        {
            string _Installed = GetSetting("installed").ToString();
            return _Installed;
        }
