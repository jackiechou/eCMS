...
namespace Eagle.Common.Settings
{
    public static class SystemSettings
    {
        ...
        public static string DBName = System.Configuration.ConfigurationManager.AppSettings["DatabaseName"].ToString();
        ...
        public static string[] LANGUAGE_CODES = { "en-US", "vi_VN"};
